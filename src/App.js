...
class App extends Component {
  ...
  onButtonSubmit = () => {
    ...
    // points for the front end to link upto in heroku.
    fetch('https://mighty-spire-82721.herokuapp.com/imageurl', {
      method: 'post',
    ...
    .then(response => response.json())
      .then(response => {
        if (response) {
          fetch('https://mighty-spire-82721.herokuapp.com/image', {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
